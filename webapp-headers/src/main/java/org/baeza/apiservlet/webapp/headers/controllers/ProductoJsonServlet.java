package org.baeza.apiservlet.webapp.headers.controllers;
...
import org.baeza.apiservlet.webapp.headers.services.ProductoService;
import org.baeza.apiservlet.webapp.headers.services.ProductoServiceImpl;
...
public class ProductoJsonServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            out.println("        <title>Detalles de producto desde JSON</title>");
            out.println("    </head>");
            out.println("    <body>");
            out.println("        <h1>Detalles de producto desde JSON</h1>");
            out.println("<ul>");
